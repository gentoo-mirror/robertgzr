...
PV_COMMIT="e78b7b85e4792f413175e13ef2fe437839b017a2"
SRC_URI="https://git.sr.ht/~sircmpwn/${PN}/archive/${PV_COMMIT}.tar.gz -> ${P}.tar.gz
...
PATCHES=(
	"${FILESDIR}/0001-Allow-overwriting-version.patch"
)
...
src_compile() {
	if use notmuch; then
		export GOTAGS=notmuch
	fi
	export VERSION="${PV}-g${PV_COMMIT:0:7}"
