...
HOMEPAGE="https://youtube-dl.org/ https://github.com/yt-dlp/yt-dlp/"
SRC_URI="
	https://github.com/yt-dlp/yt-dlp/archive/${PV}.tar.gz -> ${P}.tar.gz
	https://github.com/yt-dlp/yt-dlp/releases/download/${PV}/${PN}.tar.gz -> ${P}-assets.tar.gz
"
...
python_install_all() {
	doman ${WORKDIR}/${PN}/yt-dlp.1

	newbashcomp ${WORKDIR}/${PN}/completions/bash/yt-dlp yt-dlp

	insinto /usr/share/zsh/site-functions
	newins ${WORKDIR}/${PN}/completions/zsh/_yt-dlp _yt-dlp

	insinto /usr/share/fish/vendor_completions.d
	doins ${WORKDIR}/${PN}/completions/fish/yt-dlp.fish
